...
우리가 10진법에서 숫자의 길이를 <U>몇 자리</U>와 같이 나타내듯이, 컴퓨터에서 2진법 숫자의 각 자리를 **비트**로 나타냅니다. `1000`은 4비트, `1101 0100`은<a href="#fn-2" id="rfn-2" class="fn-link">2</a> 8비트, 이런 식으로요. 
...
> 업데이트 24/02/08: 메모리 그림을 이미지에서 표로 바꾸었습니다. 이미지를 하나하나 만들려니까 귀찮더라고요.
{: .prompt-info }

> 업데이트 24/02/09: 문단 제목과 목차를 추가했어요. 움직이기 편하게!
{: .prompt-info }
