...
> 24/02/07: 메모리 그림을 이미지에서 표로 바꾸었습니다. 이미지를 하나하나 만들려니까 귀찮더라고요.
{: .prompt-update }

> 24/02/08: 문단 제목과 목차를 추가했어요. 움직이기 편하게!
{: .prompt-update }

> 24/02/10: 이진법 표기 방식과 그에 대한 설명을 수정했습니다. 0b... 보다는 ...<sub>(2)</sub>가 읽기 편하잖아요?
{: .prompt-update }
